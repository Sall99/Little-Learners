...
const Card = ({ title, description, icon }: CardProps) => {
  return (
    <div className="relative h-_243 rounded-xl border-2 border-b-4 border-r-4 border-gray-700 bg-white px-_30 pt-_50 lg:px-10 lg:pt-_60 2xl:h-_306 2xl:w-_504 2xl:border-b-8 2xl:border-r-8 2xl:px-_50 2xl:pt-20">
