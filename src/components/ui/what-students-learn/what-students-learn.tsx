...
const Card = ({ title, description, img }: CardProps) => {
  return (
    <div className="lg-box-shadow relative m-auto rounded-xl border-2 border-gray-700 bg-white p-_30 min-[400px]:w-_358 sm:h-_433 lg:w-_400 lg:p-10 2xl:h-_570 2xl:w-_498 2xl:p-_50">
