  ...
  return (
    <section className="tuition-fees mb-10 px-4 font-outfit lg:mb-_150 lg:mt-_60 lg:px-_50 2xl:mb-_200">
      <div className="m-auto max-w-_1590">
        ...
        <div className="lg-box-shadow rounded-lg border-2 border-gray-700 bg-white p-4 lg:p-_30 xl:p-_50 2xl:p-_60">
        ...
        <div className="lg-box-shadow mt-10 rounded-lg border-2 border-gray-700 bg-white p-4 lg:p-_30 xl:mt-_60 xl:p-_50 2xl:mt-20 2xl:p-_60">
          <div className="mb-_30 rounded-xl border-2 border-gray-700 bg-primary-300 p-4 font-semibold">
